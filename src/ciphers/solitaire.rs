...
pub struct SolitaireCipher {
    deck: Deck, // the card deck configuration is the key
}
...
// takes the initial deck layout and generates the keystream
// for Solitaire
fn prepare_deck(cipher: &mut Deck) {
    // after implementing all the cuts in the card_deck
    todo!();
}
